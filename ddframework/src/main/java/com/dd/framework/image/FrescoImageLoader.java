...
//            return;
//        }
        ImageDisplayConfig config = ImageDisplayConfig.ImageDisplayConfigBuilder.newBuilder().setFailureDrawable(BaseApp.getInstance(), placeHolderRes)
                .setLoadingDrawable(BaseApp.getInstance(), placeHolderRes).build();
