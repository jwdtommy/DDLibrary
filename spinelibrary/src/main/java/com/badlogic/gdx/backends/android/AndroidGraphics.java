...
public class AndroidGraphics implements Graphics, Renderer {
	 ...
	 * {@link com.badlogic.gdx.backends.android.AndroidGraphics#pause()} they <b>MUST</b> enforce continuous rendering. If not, {@link #onDrawFrame(GL10)} will not
	 * be called in the GLThread while {@link #pause()} is sleeping in the Android UI Thread which will cause the
	 * {@link com.badlogic.gdx.backends.android.AndroidGraphics#pause} variable never be set to false. As a result, the {@link com.badlogic.gdx.backends.android.AndroidGraphics#pause()} method will
