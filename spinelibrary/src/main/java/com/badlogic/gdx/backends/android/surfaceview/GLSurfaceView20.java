...
public class GLSurfaceView20 extends GLSurfaceView {
	...
	public GLSurfaceView20 (Context context, com.badlogic.gdx.backends.android.surfaceview.ResolutionStrategy resolutionStrategy, int targetGLESVersion) {
		super(context);
		com.badlogic.gdx.backends.android.surfaceview.GLSurfaceView20.targetGLESVersion = targetGLESVersion;
		this.resolutionStrategy = resolutionStrategy;
		init(false, 16, 0);
	}

	public GLSurfaceView20 (Context context, com.badlogic.gdx.backends.android.surfaceview.ResolutionStrategy resolutionStrategy) {
		this(context, resolutionStrategy, 2);
	}

	public GLSurfaceView20 (Context context, boolean translucent, int depth, int stencil, com.badlogic.gdx.backends.android.surfaceview.ResolutionStrategy resolutionStrategy) {
		super(context);
		this.resolutionStrategy = resolutionStrategy;
	...
	static class ContextFactory implements GLSurfaceView.EGLContextFactory {
		...
		public EGLContext createContext (EGL10 egl, EGLDisplay display, EGLConfig eglConfig) {
			Log.w(TAG, "creating OpenGL ES " + com.badlogic.gdx.backends.android.surfaceview.GLSurfaceView20.targetGLESVersion + ".0 context");
			checkEglError("Before eglCreateContext "+targetGLESVersion, egl);
			int[] attrib_list = {EGL_CONTEXT_CLIENT_VERSION, com.badlogic.gdx.backends.android.surfaceview.GLSurfaceView20.targetGLESVersion, EGL10.EGL_NONE};
			EGLContext context = egl.eglCreateContext(display, eglConfig, EGL10.EGL_NO_CONTEXT, attrib_list);
			boolean success = checkEglError("After eglCreateContext "+targetGLESVersion, egl);

			if ((!success || context == null) && com.badlogic.gdx.backends.android.surfaceview.GLSurfaceView20.targetGLESVersion > 2) {
				Log.w(TAG, "Falling back to GLES 2");
				com.badlogic.gdx.backends.android.surfaceview.GLSurfaceView20.targetGLESVersion = 2;
