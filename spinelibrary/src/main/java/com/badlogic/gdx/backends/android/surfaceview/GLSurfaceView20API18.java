...
public class GLSurfaceView20API18 extends GLSurfaceViewAPI18 {
	...
	public GLSurfaceView20API18 (Context context, com.badlogic.gdx.backends.android.surfaceview.ResolutionStrategy resolutionStrategy) {
		super(context);
		this.resolutionStrategy = resolutionStrategy;
		init(false, 16, 0);
	}

	public GLSurfaceView20API18 (Context context, boolean translucent, int depth, int stencil, com.badlogic.gdx.backends.android.surfaceview.ResolutionStrategy resolutionStrategy) {
		super(context);
		this.resolutionStrategy = resolutionStrategy;
