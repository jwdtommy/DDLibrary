...
public interface AndroidApplicationBase extends Application {
	...
	/** Returns the {@link AndroidInput} object associated with this {@link com.badlogic.gdx.backends.android.AndroidApplicationBase}
	 * 
	 * @return the {@link AndroidInput} object */
	@Override
    AndroidInput getInput();

	/** Returns the {@link LifecycleListener} array associated with this {@link com.badlogic.gdx.backends.android.AndroidApplicationBase}
	 * 
