...
public class AndroidApplication extends Activity implements AndroidApplicationBase {
	 ...
	 * input, render via OpenGL and so on. Uses a default {@link com.badlogic.gdx.backends.android.AndroidApplicationConfiguration}.
	 *
	 ...
	 * {@link com.badlogic.gdx.backends.android.AndroidApplicationConfiguration} instance.
	 *
	 * @param listener the {@link ApplicationListener} implementing the program logic
	 ...
	 *           etc.). */
	public void initialize (ApplicationListener listener, com.badlogic.gdx.backends.android.AndroidApplicationConfiguration config) {
	 ...
	 *           etc.).
	 * @return the GLSurfaceView of the application */
	public View initializeForView (ApplicationListener listener, com.badlogic.gdx.backends.android.AndroidApplicationConfiguration config) {
	...
	private void init (ApplicationListener listener, AndroidApplicationConfiguration config, boolean isForView) {
		...
		if (this.useImmersiveMode && getVersion() >= Build.VERSION_CODES.KITKAT) {
			try {
				Class<?> vlistener = Class.forName("com.badlogic.gdx.backends.AndroidVisibilityListener");
