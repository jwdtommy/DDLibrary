...
public class AndroidFragmentApplication extends Fragment implements AndroidApplicationBase {
	...
	/**
	 *@J.Tommy 2017.7.4 在libgdx1.9.6基础上新增pause()方法
	 将原先onPause中的代码提炼出来，供外部主动调用，解决的主要问题是速算盒子因为按home键的时候会导致所有的fragment都触发onPause，进而在AndroidGraphics中的pause()里发生killProcess
	 */
	public void pause(){
	...
	/**
	 * @J.Tommy 2017.7.4 在libgdx1.9.6基础上新增resume()方法，
	 */
	public void resume(){
		Gdx.app = this;
		Gdx.input = this.getInput();
