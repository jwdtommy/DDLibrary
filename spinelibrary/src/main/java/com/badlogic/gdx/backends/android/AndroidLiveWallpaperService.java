 ...
 * 
 * Derive from this class. In the {@link com.badlogic.gdx.backends.android.AndroidLiveWallpaperService#onCreateApplication} method call the
 * {@link com.badlogic.gdx.backends.android.AndroidLiveWallpaperService#initialize(ApplicationListener)} method specifying the configuration for the GLSurfaceView.
...
// ApplicationListener.dispose is not called for wallpapers
	 ...
	 * {@link com.badlogic.gdx.backends.android.AndroidLiveWallpaperService#initialize(ApplicationListener, com.badlogic.gdx.backends.android.AndroidApplicationConfiguration)} from there. */
	public void onCreateApplication () {
		if (DEBUG) Log.d(TAG, " > AndroidLiveWallpaperService - onCreateApplication()");
	}

	/** Look at {@link com.badlogic.gdx.backends.android.AndroidLiveWallpaperService#initialize(ApplicationListener, com.badlogic.gdx.backends.android.AndroidApplicationConfiguration)}
	 * @param listener */
	...
	/** This method has to be called in the {@link com.badlogic.gdx.backends.android.AndroidLiveWallpaperService#onCreateApplication} method. It sets up all the
	 ...
	 * of the fields in the {@link com.badlogic.gdx.backends.android.AndroidApplicationConfiguration} instance.
	 *
	 * @param listener the {@link ApplicationListener} implementing the program logic
	 * @param config the {@link com.badlogic.gdx.backends.android.AndroidApplicationConfiguration}, defining various settings of the application (use accelerometer,
	...
	public class AndroidWallpaperEngine extends Engine {
		...
		public void onSurfaceCreated (final SurfaceHolder holder) {
			...
			if (engines == 1 && app == null) {
				...
				app = new AndroidLiveWallpaper(com.badlogic.gdx.backends.android.AndroidLiveWallpaperService.this);
